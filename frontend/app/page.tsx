    ...
    <>
      ...
      <div className="h-[100vh] bg-[url('../public/background.webp')] bg-fixed bg-cover flex justify-center items-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-2xl pl-7">a voting platform powered by web3</div>
          <Button className="ml-3 mt-20 rounded-sm bg-white text-black font-oswald text-2xl py-1 px-3 hover:bg-salmon">Get Started</Button>
        </div>
      </div>
